...
public class SimpleButton {
    ...
    public void draw() {
        GLUtils.drawGradientBorderedRect((double) this.getX(), (double) this.getY(), (double) this.getX() + sizeX, this.getY() + sizeY, 0.5f, GLUtils.getColor(96, 96, 96), !pressed ? 0 : GLUtils.getColor(64, 128, 128, 128), !pressed ? GLUtils.getColor(32, 96, 96, 96) : GLUtils.getColor(96, 0, 255, 0));
